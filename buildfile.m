...
versionString = feval( @(s) s(end).Version, ...
...
reqaddsoft = struct("Name", "SHAPEtoolbox", ...
    "Platform", "win64", ...
    "DownloadURL", "https://epos-apps.grid.cyfronet.pl/tcs-ah/sera-applications/archive/master.zip", ...
    "LicenseURL", "https://epos-apps.grid.cyfronet.pl/tcs-ah/sera-applications/src/branch/master/SHAPE_Package/SHAPE_ver2b.0/SSH/dist_GRT.m");
reqaddsoft = repmat(reqaddsoft, 1, 3);
